...
// AuthenticateApi: Middleware autentikasi untuk Order-Payment Service.
//
// CATATAN ARSITEKTUR:
// Dalam sistem microservice ini, autentikasi utama dilakukan di API Gateway.
// Order-Payment Service menerima request yang sudah divalidasi oleh Gateway.
// Middleware ini memvalidasi internal service token (X-Service-Token)
// yang dikirim oleh Gateway atau service lain (misal Core Service).
//
