...
// RoleMiddleware: Otorisasi berdasarkan role user untuk Order-Payment Service.
//
// CATATAN ARSITEKTUR:
...
//   Route::post('/orders', ...)->middleware('role:admin,patient');
//   Route::get('/orders', ...)->middleware('role:admin');
